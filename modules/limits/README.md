...
Rate-limit and quota rows grow with distinct windows, subjects, and metrics. Production deployments must define retention appropriate to their traffic and evidence requirements. Live concurrency proof still belongs in the isolated PostgreSQL certification suite.
